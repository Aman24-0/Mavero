...
<style>
  ...
  .profile-avatar { display: grid; place-items: center; width: 78px; height: 78px; border: 1px solid rgba(216,163,78,.55); border-radius: 50%; color: var(--base); background: linear-gradient(145deg, var(--accent-strong), var(--secondary)); font-family: 'Cormorant Garamond', Georgia, serif; font-size: 1.5rem; font-weight: 700; }
  .identity-copy h1 { margin: 10px 0 8px; font-family: 'Cormorant Garamond', Georgia, serif; font-size: clamp(3rem, 5.5vw, 5.8rem); font-weight: 600; letter-spacing: -.07em; line-height: .8; }
  ...
  .profile-card-main { background: radial-gradient(circle at 88% 18%, rgba(169,208,191,.12), transparent 20rem), var(--surface); }
  .profile-card h2 { max-width: 440px; margin: 13px 0 9px; font-family: 'Cormorant Garamond', Georgia, serif; font-size: 2.2rem; font-weight: 600; letter-spacing: -.045em; line-height: .9; }
  ...
  .activity-list strong { color: var(--ink); font-family: 'Cormorant Garamond', Georgia, serif; font-size: 1.6rem; font-weight: 600; line-height: .8; }
  ...
  .identity-panel { display: grid; grid-template-columns: 46px minmax(0, 1fr) auto; align-items: center; gap: 15px; margin-top: 54px; padding: 22px; border: 1px solid rgba(169,208,191,.27); border-radius: var(--radius-lg); background: linear-gradient(110deg, rgba(169,208,191,.11), rgba(216,163,78,.05)); }
  ...
  .identity-panel h2 { margin: 8px 0 5px; font-family: 'Cormorant Garamond', Georgia, serif; font-size: 1.8rem; font-weight: 600; letter-spacing: -.04em; line-height: .88; }
  ...
  .preferences h2 { margin: 9px 0 0; font-family: 'Cormorant Garamond', Georgia, serif; font-size: 2rem; font-weight: 600; letter-spacing: -.05em; }
  ...
  .signout-btn { color: #f2b2ba; border-color: rgba(231,140,141,.32); background: rgba(231,140,141,.08); }
