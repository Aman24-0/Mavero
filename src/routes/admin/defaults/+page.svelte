...
<AdminShell active="defaults">
  ...
  <!-- Adult Mode admin controls — API-driven, server-authoritative. -->
  <AdminSection
...
<style>
  ...
  .adult-toggles { display: grid; gap: 14px; margin-top: 8px; }
  .adult-toggle-row { display: flex; align-items: center; justify-content: space-between; gap: 16px; padding: 14px 16px; border: 1px solid var(--color-border-strong); border-radius: var(--radius-sm); background: var(--color-surface-elevated); cursor: pointer; }
  .adult-toggle-row .toggle-copy { display: grid; gap: 4px; }
  .adult-toggle-row .toggle-copy strong { color: var(--color-text); font-size: .8rem; font-weight: 700; }
  .adult-toggle-row .toggle-copy small { color: var(--color-text-muted); font-size: .6rem; line-height: 1.5; }
  ...
  @media (max-width: 700px) {
    ...
    .adult-toggle-row { flex-direction: column; align-items: flex-start; gap: 12px; }
  }
</style>
