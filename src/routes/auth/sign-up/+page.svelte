...
<style>
  ...
  .auth-card { width: min(480px, 100%); margin: 54px auto 0; padding: 30px; border: 1px solid var(--line); border-radius: var(--radius-xl); background: linear-gradient(135deg, rgba(145,182,173,.06), rgba(16,22,25,.96)); box-shadow: var(--shadow-lg); }
  .auth-card h1 { margin: 9px 0 13px; font-family: 'Space Grotesk', sans-serif; font-size: clamp(2.4rem, 6vw, 4rem); line-height: .95; letter-spacing: -.08em; }
  ...
  .resend-form input { width: 100%; padding: 12px; border: 1px solid var(--line); border-radius: var(--radius-sm); outline: 0; color: var(--ink); background: rgba(228,235,232,.035); font-size: .8rem; }
