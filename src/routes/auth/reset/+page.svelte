<script lang="ts">
  import { LockKeyhole, ShieldCheck, AlertCircle, ArrowRight } from 'lucide-svelte';
  ...
  {#if data.ready}
    <form method="POST" class="auth-form">
      ...
      <label class="field">
        ...
        <div class="input-wrap">
          <LockKeyhole size={15} class="input-icon" />
          <input name="confirmation" type="password" autocomplete="new-password" minlength="6" placeholder="Repeat your password" required />
        </div>
      </label>
...
<style>
  ...
  @media (prefers-reduced-motion: reduce) {
    .primary-cta, .secondary-cta, .input-wrap { transition: none; }
  }
</style>
