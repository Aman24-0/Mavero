...
<style>
  ...
  @media (max-width: 640px) { .back-link { padding-top: 88px; } .collection-heading { padding: 28px 0 18px; } .heading-row { align-items: start; } .collection-heading h1 { font-size: 4rem; } .collection-count { padding-top: 5px; } .collection-tools { margin-bottom: 20px; } .results-grid { grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 24px 11px; } .pagination { padding-bottom: 26px; } .pagination-link { padding-inline: 10px; } }
</style>
