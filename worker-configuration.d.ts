/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cdc7abf434b36c9f669f810f14c5fcfe)
// Runtime types generated with workerd@1.20260815.1 2026-08-15 
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	PUBLIC_SUPABASE_URL: string;
	PUBLIC_SUPABASE_PUBLISHABLE_KEY: string;
	PUBLIC_SUPABASE_AUTH_REDIRECT_URL: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_SUPABASE_URL" | "PUBLIC_SUPABASE_PUBLISHABLE_KEY" | "PUBLIC_SUPABASE_AUTH_REDIRECT_URL">> {}
}
