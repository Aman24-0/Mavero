...
const providerId = '00000000-0000-4000-8000-0000000007f5';
const sourceId = '00000000-0000-4000-8000-0000000007f6';
const iframeOrigin = 'https://vidapi.qzz.io';
...
const source = {
  ...
  name: 'VidAPI.qzz.io Embed',
  status: 'experimental',
  enabled: true,
  visibility: 'public' as const,
  integration_type: 'template' as const,
  capabilities,
  movie_template: `${iframeOrigin}/movie/{tmdb_id}`,
  series_template: `${iframeOrigin}/tv/{tmdb_id}/{season}/{episode}`,
  anime_template: null,
...
assert.equal(episode.url, `${iframeOrigin}/tv/1399/1/1`);
...
console.log('Phase 7E VidAPI.qzz.io generic-template and resolver tests passed.');
