...
const providerId = '00000000-0000-4000-8000-0000000007e7';
const sourceId = '00000000-0000-4000-8000-0000000007e8';
const nxshaOrigin = 'https://nxsha.space';
...
const capabilities = {
  ...
  allowed_embed_origins: [nxshaOrigin]
};
...
const source = {
  ...
  integration_type: 'template' as const,
  capabilities,
  movie_template: `${nxshaOrigin}/embed/movie/{tmdb_id}`,
  series_template: `${nxshaOrigin}/embed/tv/{tmdb_id}/{season}/{episode}`,
  anime_template: null,
...
assert.equal(episode.url, `${nxshaOrigin}/embed/tv/1399/1/1`);
...
console.log('Phase 7E Nxsha generic-template and resolver tests passed.');
