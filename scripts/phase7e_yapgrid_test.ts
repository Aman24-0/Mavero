...
const yapgridOrigin = 'https://yapgrid.com';
...
const capabilities = {
  ...
  allowed_embed_origins: [yapgridOrigin]
};
...
const source = {
  ...
  integration_type: 'template' as const,
  capabilities,
  movie_template: `${yapgridOrigin}/embed/movie/{tmdb_id}`,
  series_template: `${yapgridOrigin}/embed/tv/{tmdb_id}/{season}/{episode}`,
  anime_template: null,
...
assert.equal(episode.url, `${yapgridOrigin}/embed/tv/1399/1/1`);
