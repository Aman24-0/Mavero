...
const providerId = '00000000-0000-4000-8000-0000000007ef';
const sourceId = '00000000-0000-4000-8000-0000000007f0';
const vidphantomOrigin = 'https://vidphantom.com';
...
const capabilities = {
  ...
  allowed_embed_origins: [vidphantomOrigin]
};
...
const source = {
  ...
  name: 'VidPhantom Embed',
  status: 'experimental',
  enabled: true,
  visibility: 'public' as const,
  integration_type: 'template' as const,
  capabilities,
  movie_template: `${vidphantomOrigin}/movie/{tmdb_id}`,
  series_template: `${vidphantomOrigin}/tv/{tmdb_id}/{season}/{episode}`,
  anime_template: null,
...
assert.equal(episode.url, `${vidphantomOrigin}/tv/1399/1/1`);
...
console.log('Phase 7E VidPhantom generic-template and resolver tests passed.');
