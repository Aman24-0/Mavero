...
// ===========================================================================
{
  ...
  ok(
    testScript.indexOf('stremio_player_phase7_test.ts') !== -1 &&
      ...
      testScript.trimEnd().endsWith('device_pairing_test.ts'),
    'A: test chain runs phase 8 after phase 7 and ends with the device pairing suite (Phase 9–20 extension + Phase 1–3 Device Auth)',
  );
