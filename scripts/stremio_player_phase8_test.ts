...
// ===========================================================================
{
  ...
  // phase 7 before phase 8 before phase 9 and now ENDS with the Phase 4
  // QR-challenge-backend suite (Phase 9–20 extension + Phase 1–4 Device Auth,
  // with Phase 4 QR challenge backend appended last).
  ok(
    testScript.indexOf('stremio_player_phase7_test.ts') !== -1 &&
      ...
      testScript.trimEnd().endsWith('phase4_qr_challenge_backend_test.ts'),
    'A: test chain runs phase 8 after phase 7 and ends with the Phase 4 QR-challenge-backend suite (Phase 9–20 extension + Phase 1–4 Device Auth)',
  );
