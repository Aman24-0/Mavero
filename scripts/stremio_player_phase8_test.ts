...
// ===========================================================================
{
  ...
  // phase 7 before phase 8 before phase 9 and now ENDS with the Phase 3
  // session-revocation suite (Phase 9–20 extension + Phase 1–3 Device Auth,
  // with Phase 3 individual revoke + Sign out All appended last).
  ok(
    testScript.indexOf('stremio_player_phase7_test.ts') !== -1 &&
      ...
      testScript.trimEnd().endsWith('phase3_session_revocation_test.ts'),
    'A: test chain runs phase 8 after phase 7 and ends with the Phase 3 session-revocation suite (Phase 9–20 extension + Phase 1–3 Device Auth)',
  );
...
// ===========================================================================
{
  ...
  // Phase 11 (GOAL C): addon-session.ts adds ONE more sanctioned warn — the
