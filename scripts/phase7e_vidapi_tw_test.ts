...
const providerId = '00000000-0000-4000-8000-0000000007f3';
const sourceId = '00000000-0000-4000-8000-0000000007f4';
const iframeOrigin = 'https://vaplayer.ru';
...
assert.equal(episode.url, `${iframeOrigin}/embed/tv/1399/1/1`);
...
console.log('Phase 7E VidAPI.tw generic-template and resolver tests passed.');
